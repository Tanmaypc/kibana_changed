...
export const BetaConnectorCallout: React.FC = () => (
  <BetaCallOut
    ...
    description={i18n.translate('xpack.enterpriseSearch.betaConnectorCalloutDescription', {
      defaultMessage:
        'This connector is in beta. Beta features may change and are not covered by the support SLA for generally available features. Cyberstanc plans to promote this feature to general availability in a future release.',
    })}
  />
);
