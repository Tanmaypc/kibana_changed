  ...
  return (
    <SearchEmptyPrompt
      ...
      title={i18n.translate('xpack.serverlessSearch.elasticManagedConnectorEmpty.title', {
        defaultMessage: 'Cyberstanc-managed connectors',
      })}
                  ...
                  <EuiFlexGroup justifyContent="flexStart" alignItems="center" direction="column">
                    <EuiFlexItem grow={false}>
                      ...
                      >
                        ...
                        <EuiFlexItem>
                          <EuiIcon color="primary" size="l" type="cloud" />
                        </EuiFlexItem>
                      </EuiFlexGroup>
                    </EuiFlexItem>
                    <EuiFlexItem>
                      <EuiText>
                        <p>
                          {i18n.translate(
                            ...
                            {
                              defaultMessage:
                                'Enter access and connection details for your data source and run your first sync in Cyberstanc',
                            }
                          )}
                        </p>
                      </EuiText>
