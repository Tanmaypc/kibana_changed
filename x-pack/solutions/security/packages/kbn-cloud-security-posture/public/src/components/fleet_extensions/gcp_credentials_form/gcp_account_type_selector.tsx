        ...
        <>
          ...
          <EuiText color="subdued" size="s">
            <FormattedMessage
              ...
              defaultMessage="Connect Cyberstanc to every GCP project—current and future—in your environment by providing Cyberstanc with read-only configuration access to your GCP organization."
            />
          </EuiText>
        </>
      )}
