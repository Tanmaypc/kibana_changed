  ...
  if (azureCredentialType === 'cloud_connectors') {
    ...
    const step2 = (
      <FormattedMessage
        ...
        defaultMessage="Return to Cyberstanc. Click {deployButton}, below."
        values={{
    ...
    const step6 = (
      <FormattedMessage
        ...
        defaultMessage="Once the deployment is complete, go to the {outputs} tab, copy the {outputValues} fields, and paste them into Cyberstanc below."
        values={{
