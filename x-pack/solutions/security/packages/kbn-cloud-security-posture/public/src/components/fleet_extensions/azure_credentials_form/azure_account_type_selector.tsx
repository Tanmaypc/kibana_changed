        ...
        <>
          ...
          <EuiText color="subdued" size="s">
            <FormattedMessage
              ...
              defaultMessage="Connect Cyberstanc to every Azure subscription—current and future—in your environment by providing Cyberstanc with read-only configuration access to your Azure organization (tenant root group)."
            />
          </EuiText>
        </>
      )}
