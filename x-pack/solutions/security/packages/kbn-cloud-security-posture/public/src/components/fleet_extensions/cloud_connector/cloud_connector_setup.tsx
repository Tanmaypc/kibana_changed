          ...
          <div>
            <EuiText size="s" color="subdued">
              <FormattedMessage
                ...
                defaultMessage="Create a reusable IAM role in your AWS account, then give Cyberstanc its role ARN and the external ID shown below. You’ll need permission to launch a CloudFormation stack and create or update IAM roles in the target AWS account. {learnMore}"
                values={{
                  learnMore: (
                    <EuiLink
