                ...
                <>
                  <p>
                    <FormattedMessage
                      ...
                      defaultMessage="Asset Inventory provides a unified view of all your organization's assets in one place. See everything detected by Cyberstanc Security — whether from logs, {identity_providers}, {cloud_services}, {mdms}, or configuration {databases} — in a structured, searchable inventory. Enable Asset Inventory to gain complete visibility across your environment."
                      values={{
                        identity_providers: (
