    ...
    <EuiEmptyPrompt
      ...
      body={
        <>
          <p>
            <FormattedMessage
              defaultMessage="To display map data, you must define SIEM indices ({defaultIndex}) and Cyberstanc index patterns with matching glob patterns. When using {beats}, you can run the {setup} command on your hosts to automatically create the index patterns. For example: {example}."
          ...
          <p>
            <FormattedMessage
              defaultMessage="You can also configure index patterns manually in Cyberstanc."
