...
describe('NoApiIntegrationKeyCallOut', () => {
  ...
  it('should show callout', () => {
    ...
    expect(getByTestId(NO_INTEGRATION_CALLOUT_TEST_ID)).toHaveTextContent(
      'A new encryption key is generated for saved objects each time you start Cyberstanc. Without a persistent key, you cannot delete or modify rules after Cyberstanc restarts. To set a persistent key, add the xpack.encryptedSavedObjects.encryptionKey setting with any text value of 32 or more characters to the kibana.yml file.'
    );
