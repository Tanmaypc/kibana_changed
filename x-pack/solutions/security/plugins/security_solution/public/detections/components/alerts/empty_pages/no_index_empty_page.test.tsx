...
describe('NoIndexEmptyPage', () => {
  ...
  it('should render empty message', () => {
    ...
    expect(getByTestId(NO_INDEX_TEST_ID)).toHaveTextContent(
      'To use the detection engine, a user with the required cluster and index privileges must first access this page. For more help, contact your Cyberstanc administrator.'
    );
  });
});
