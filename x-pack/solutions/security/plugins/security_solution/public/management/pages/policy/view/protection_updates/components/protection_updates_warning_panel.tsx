...
export const ProtectionUpdatesWarningPanel = () => (
  ...
  >
    <FormattedMessage
      ...
      defaultMessage="Cyberstanc provides periodic updates to protection artifacts such as the global exception list, malware models, and rule packages to ensure your environment is up to date with the latest protections. By default, these artifacts are updated automatically. Disable the automatic updates toggle to manually manage updates to the protection artifacts."
    />
    <EuiSpacer size="s" />
    <FormattedMessage
