...
export const AdvancedPolicySchema: AdvancedPolicySchemaType[] = [
  ...
  },
  {
    ...
    documentation: i18n.translate(
      ...
      {
        defaultMessage: 'Download default event filter rules from Cyberstanc. Default: true',
      }
    ),
  },
  {
  ...
  },
  {
    ...
    documentation: i18n.translate(
      ...
      {
        defaultMessage:
          'This setting ensures thread capability arrays are not pruned from Linux process events before being sent to Elasticsearch. At the expense of higher Endpoint data volumes, a true value ensures capability-matching detection rules running in Cyberstanc can match. Detection rules running within Elastic Defend are unaffected because capabilities are conditionally pruned after rule processing. Default is false.',
      }
    ),
  },
  {
