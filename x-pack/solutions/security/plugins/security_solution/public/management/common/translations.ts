...
export const CONSOLE_COMMANDS = {
  isolate: {
    ...
    privileges: i18n.translate(
      ...
      {
        defaultMessage:
          'Insufficient privileges to isolate hosts. Contact your Cyberstanc administrator if you think you should have this permission.',
      }
    ),
  },
  release: {
  ...
  killProcess: {
    ...
    privileges: i18n.translate(
      ...
      {
        defaultMessage:
          'Insufficient privileges to kill process. Contact your Cyberstanc administrator if you think you should have this permission.',
      }
    ),
    args: {
      pid: {
  ...
  suspendProcess: {
    ...
    privileges: i18n.translate(
      ...
      {
        defaultMessage:
          'Insufficient privileges to suspend process. Contact your Cyberstanc administrator if you think you should have this permission.',
      }
    ),
    args: {
      pid: {
...
`,
    ...
    privileges: i18n.translate(
      ...
      {
        defaultMessage:
          'Insufficient privileges to run script. Contact your Cyberstanc administrator if you think you should have this permission.',
      }
    ),
  },
};
