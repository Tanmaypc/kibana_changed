...
export const MINIMIZE_ALERT_FATIGUE = i18n.translate(
  ...
  {
    defaultMessage:
      'Cyberstanc Attack Discovery minimizes alert fatigue by filtering out most noise, escalating credible threats, and maintaining a low false-positive rate. This lets security teams focus on real investigations instead of sifting through irrelevant alerts.',
  }
);
...
export const ESCALATED_ALERTS_2 = i18n.translate(
  ...
  {
    defaultMessage:
      ' were escalated for analyst review — highlighting that Cyberstanc Attack Discovery surfaces the alerts most likely to be tied to actual threats',
  }
);
...
export const EXECUTIVE_SUMMARY_SUBTITLE = i18n.translate(
  ...
  {
    defaultMessage: 'Cyberstanc AI SOC Engine continues to deliver measurable ROI: ',
  }
);
