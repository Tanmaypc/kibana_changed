...
export const AnalyzerPreviewNoDataMessage: React.FC = () => {
  return (
    <FormattedMessage
      ...
      defaultMessage="You can only visualize events triggered by hosts configured with the Scrutiny EDR integration or any {sysmon} data from {winlogbeat}. Refer to {link} for more information."
      values={{
        sysmon: <EuiMark>{'sysmon'}</EuiMark>,
        winlogbeat: <EuiMark>{'winlogbeat'}</EuiMark>,
        link: (
          <EuiLink
            href="https://enterprise.cyberstanc.com/guide/en/security/current/visual-event-analyzer.html"
            target="_blank"
          >
            <FormattedMessage
