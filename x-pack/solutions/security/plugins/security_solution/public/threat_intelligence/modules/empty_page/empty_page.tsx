      ...
      title={
        <h3>
          <FormattedMessage
            ...
            defaultMessage="Get started with Cyberstanc Threat Intelligence"
          />
        </h3>
      }
      titleSize="s"
        ...
        <>
          <p>
            <FormattedMessage
              ...
              defaultMessage="Cyberstanc Threat Intelligence makes it easy to analyze and investigate potential security
          ...
          <p>
            <FormattedMessage
              ...
              defaultMessage="To get started with Cyberstanc Threat Intelligence, enable one or more Threat Intelligence
