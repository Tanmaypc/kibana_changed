...
export const EXPLAIN_THEN_SUMMARIZE_SUGGEST_INVESTIGATION_GUIDE = i18n.translate(
  ...
  {
    defaultMessage: `Evaluate the security event described above and provide a structured, markdown-formatted summary suitable for inclusion in a Cyberstanc Security case. Ensure you're using all tools available to you. Your response must include:
1. Event Description
