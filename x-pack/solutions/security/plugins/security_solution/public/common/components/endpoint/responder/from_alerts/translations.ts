...
export const NOT_FROM_ENDPOINT_HOST_TOOLTIP = i18n.translate(
  ...
  {
    defaultMessage: 'Add the Scrutiny EDR integration via Cyberstanc Agent to enable this feature',
  }
);
export const HOST_ENDPOINT_UNENROLLED_TOOLTIP = i18n.translate(
  ...
  { defaultMessage: 'Host is no longer enrolled with the Scrutiny EDR integration' }
);
