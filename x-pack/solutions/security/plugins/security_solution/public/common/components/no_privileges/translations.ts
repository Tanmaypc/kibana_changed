...
export const NO_PRIVILEGES_PER_PAGE_MESSAGE = (pageName: string) =>
  i18n.translate('xpack.securitySolution.noPrivilegesPerPageMessage', {
    values: { pageName },
    defaultMessage:
      'To view {pageName}, you must update privileges. For more information, contact your Cyberstanc administrator.',
  });
...
export const NO_PRIVILEGES_DEFAULT_MESSAGE = i18n.translate(
  ...
  {
    defaultMessage:
      'To view this page, you must update privileges. For more information, contact your Cyberstanc administrator.',
  }
);
