...
export const SIEM_HEADER = i18n.translate(
  ...
  {
    defaultMessage: 'Cyberstanc Security',
  }
);
...
export const SIEM_TITLE = i18n.translate(
  ...
  {
    defaultMessage: 'Security at the speed of Cyberstanc',
  }
);
export const SIEM_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      'Cyberstanc Security equips teams to prevent, detect, and respond to threats at cloud speed and scale — securing business operations with a unified, open platform.',
  }
);
...
export const ENDPOINT_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage: 'Prevent, collect, detect and respond — all with Cyberstanc Agent.',
  }
);
...
export const UNIFY_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      'Cyberstanc Security modernizes security operations — enabling analytics across years of data, automating key processes, and protecting every host.',
  }
);
