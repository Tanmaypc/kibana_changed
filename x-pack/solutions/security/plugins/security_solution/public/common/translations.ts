...
export const UPGRADE_AGENT_FOR_RESPONDER = (
  ...
  if (_agentType === 'endpoint') {
    return i18n.translate('xpack.securitySolution.endpoint.actions.unsupported.message', {
      defaultMessage: `The current version of the {agentType} Agent does not support {command}. Upgrade your Cyberstanc Agent through Fleet to the latest version to enable this response action.`,
