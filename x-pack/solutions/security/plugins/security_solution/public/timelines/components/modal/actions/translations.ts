...
export const CALL_OUT_UNAUTHORIZED_MSG = i18n.translate(
  ...
  {
    defaultMessage:
      'You can use Timeline to investigate events, but you do not have the required permissions to save timelines for future use. If you need to save timelines, contact your Cyberstanc administrator.',
  }
);
