...
describe('OpenTimeline', () => {
  ...
  test("it should not render bulk actions if timelineStatus is immutable (selecting Cyberstanc templates' tab)", () => {
    const defaultProps = {
      ...getDefaultTestProps(mockResults),
  ...
  test("it should not render a selectable timeline table if timelineStatus is immutable (selecting Cyberstanc templates' tab)", () => {
    useUserPrivilegesMock.mockReturnValue({
      timelinePrivileges: { crud: true, read: true },
    });
    const defaultProps = {
  ...
  test("it should not render selected count if timelineStatus is immutable (selecting Cyberstanc templates' tab)", () => {
    const defaultProps = {
      ...getDefaultTestProps(mockResults),
      timelineStatus: TimelineStatusEnum.immutable,
    };
