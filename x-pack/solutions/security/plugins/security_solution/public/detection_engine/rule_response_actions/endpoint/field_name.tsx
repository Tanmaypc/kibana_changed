    ...
    if (contains) {
      return (
        <FormattedMessage
          ...
          defaultMessage="Entity_id is an Scrutiny EDR agent specific field, if the alert does not come from Scrutiny EDR agent we will not be able to send the action."
        />
      );
    }
    return (
