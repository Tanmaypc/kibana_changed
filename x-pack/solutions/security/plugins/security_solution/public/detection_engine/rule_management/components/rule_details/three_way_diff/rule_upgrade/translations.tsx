...
export const VERSION_UPDATE_INFO = (
  ...
  <FormattedMessage
    ...
    defaultMessage="{numOfFieldsWithUpdatesValue} {numOfFieldsWithUpdates, plural, one {field} other {fields}} being changed in this Cyberstanc update from version {currentVersionNumber} to {targetVersionNumber}"
    values={{
...
export const RULE_HAS_SOFT_CONFLICTS_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      'We auto-resolved the conflicts between your changes and the Cyberstanc update. Review them and do one of the following:',
  }
);
...
export const RULE_HAS_HARD_CONFLICTS_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      "We couldn't auto-resolve the conflicts between your changes and the Cyberstanc update. To resolve them, do one of the following:",
  }
);
...
export const RULE_HAS_HARD_CONFLICTS_KEEP_YOUR_CHANGES = i18n.translate(
  ...
  {
    defaultMessage: 'Keep your changes and reject the Cyberstanc update.',
  }
);
...
export const RULE_HAS_HARD_CONFLICTS_ACCEPT_ELASTIC_UPDATE = i18n.translate(
  ...
  {
    defaultMessage: 'Accept the Cyberstanc update and overwrite your changes.',
  }
);
...
export const RULE_HAS_HARD_CONFLICTS_EDIT_FINAL_VERSION = i18n.translate(
  ...
  {
    defaultMessage:
      'Edit the final version by combining your changes with the Cyberstanc update or choosing a more appropriate field value.',
  }
);
...
export const RULE_BASE_VERSION_IS_MISSING_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      "The original, unedited version of this Cyberstanc rule couldn't be found. This sometimes happens when a rule hasn't been updated in a while. You can still update this rule, but will only have access to its current version and the incoming Cyberstanc update. Updating Cyberstanc rules more often can help you avoid this in the future. We encourage you to review this update carefully and ensure your changes are not accidentally overwritten.",
  }
);
