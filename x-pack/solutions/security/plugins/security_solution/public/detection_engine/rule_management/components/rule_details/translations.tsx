...
export const UPDATES_TAB_LABEL = i18n.translate(
  ...
  {
    defaultMessage: 'Cyberstanc update overview',
  }
);
...
export const MODIFIED_PREBUILT_RULE_LABEL = i18n.translate(
  ...
  {
    defaultMessage: 'Modified Cyberstanc rule',
  }
);
...
export const MODIFIED_FIELD_BADGE_TOOLTIP_CONTENT = i18n.translate(
  ...
  {
    defaultMessage:
      'This field has been modified from the original Cyberstanc version. Click to open.',
  }
);
...
export const HAS_RULE_UPDATE_CALLOUT_TITLE = i18n.translate(
  ...
  {
    defaultMessage: 'Cyberstanc rule update available',
  }
);
...
export const MODIFIED_PREBUILT_DIFF_TOOLTIP_CONTENT = i18n.translate(
  ...
  {
    defaultMessage:
      'This rule has been modified from the original Cyberstanc version. Click to open.',
  }
);
...
export const NO_BASE_VERSION_MODIFIED_PREBUILT_DIFF_TOOLTIP_CONTENT = i18n.translate(
  ...
  {
    defaultMessage:
      "This rule hasn't been updated in a while and the original Cyberstanc version cannot be found. We recommend updating this rule to the latest version.",
  }
);
