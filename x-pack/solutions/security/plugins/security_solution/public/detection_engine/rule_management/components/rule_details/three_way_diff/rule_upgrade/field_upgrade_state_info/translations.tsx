...
export const NO_UPDATE_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage: 'This field has no Cyberstanc update but can still be edited if needed.',
  }
);
...
export const SAME_UPDATE_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      'The field was modified after rule installation, and your changes are the same as the update from Cyberstanc.',
  }
);
...
export const NO_CONFLICT_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      "There are no conflicts with the field's current value and incoming Cyberstanc update.",
  }
);
...
export const SOLVABLE_CONFLICT_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      "We combined your changes with changes from the Cyberstanc update. Review the suggested changes to ensure they're correct.",
  }
);
