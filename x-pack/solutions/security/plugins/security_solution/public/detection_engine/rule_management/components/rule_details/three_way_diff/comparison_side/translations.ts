...
export const UPDATE_FROM_ELASTIC_TITLE = i18n.translate(
  ...
  {
    defaultMessage: 'Changes from Cyberstanc',
  }
);
...
export const UPDATE_FROM_ELASTIC_EXPLANATION = i18n.translate(
  ...
  {
    defaultMessage:
      "Compare the field's original value with changes from the Cyberstanc update. Your changes aren't displayed.",
  }
);
...
export const MERGED_CHANGES_TITLE = i18n.translate(
  ...
  {
    defaultMessage: "My changes merged with Cyberstanc's",
  }
);
...
export const MERGED_CHANGES_EXPLANATION = i18n.translate(
  ...
  {
    defaultMessage:
      "Compare the field's original value with a version that combines your changes with those in the Cyberstanc update. This version is only a suggestion.",
  }
);
