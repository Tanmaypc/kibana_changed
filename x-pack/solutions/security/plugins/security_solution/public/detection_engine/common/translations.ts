...
export const BULK_EDIT_FLYOUT_FORM_ADD_INVESTIGATION_FIELDS_HELP_TEXT = i18n.translate(
  ...
  {
    defaultMessage:
      'Enter the fields you want to add. You can choose from fields included in the default Cyberstanc Security indices.',
  }
);
...
export const LACK_OF_KIBANA_ACTIONS_FEATURE_PRIVILEGES = i18n.translate(
  ...
  {
    defaultMessage: 'You do not have Cyberstanc Actions privileges',
  }
);
...
export const LACK_OF_KIBANA_SECURITY_PRIVILEGES = i18n.translate(
  ...
  {
    defaultMessage: 'You do not have Cyberstanc Security privileges',
  }
);
...
export const REVERT_RULE = i18n.translate(
  ...
  {
    defaultMessage: 'Revert to Cyberstanc version',
  }
);
...
export const ELASTIC_RULES = i18n.translate(
  ...
  {
    defaultMessage: 'Cyberstanc rules',
  }
);
...
export const MODIFIED_TOOLTIP = i18n.translate(
  ...
  {
    defaultMessage: 'This Cyberstanc rule has been modified.',
  }
);
...
export const SOLVABLE_CONFLICT_TOOLTIP = i18n.translate(
  ...
  {
    defaultMessage:
      'This Cyberstanc rule has auto-resolved conflicts to review before updating the rule. ',
  }
);
...
export const NON_SOLVABLE_CONFLICT_TOOLTIP = i18n.translate(
  ...
  {
    defaultMessage:
      'This Cyberstanc rule has unresolved conflicts that you must fix before updating the rule.',
  }
);
...
export const NO_RULES_AVAILABLE_FOR_INSTALL = i18n.translate(
  ...
  {
    defaultMessage: 'All Cyberstanc rules have been installed',
  }
);
...
export const NO_RULES_AVAILABLE_FOR_UPGRADE = i18n.translate(
  ...
  {
    defaultMessage: 'All Cyberstanc rules are up to date',
  }
);
...
export const NO_RULES_AVAILABLE_FOR_UPGRADE_BODY = i18n.translate(
  ...
  {
    defaultMessage: 'There are currently no available updates to your installed Cyberstanc rules.',
  }
);
...
export const RULES_BULK_EDIT_SUCCESS_DATA_VIEW_RULES_SKIPPED_DETAIL = i18n.translate(
  ...
  {
    defaultMessage:
      'If you did not apply changes to rules using Cyberstanc data views, those rules were not updated and will continue using data views.',
  }
);
...
export const EXPLAIN_THEN_SUMMARIZE_RULE_DETAILS = i18n.translate(
  ...
  {
    defaultMessage:
      'Please provide a comprehensive analysis of each selected Cyberstanc Security detection rule. For each rule, include:\n' +
      '- The rule name and a brief summary of its purpose.\n' +
      '- The full detection query as published in the Cyberstanc detection rules repository.\n' +
...
export const GO_BACK_TO_RULES_TABLE_BUTTON = i18n.translate(
  ...
  {
    defaultMessage: 'Go back to installed Cyberstanc rules',
  }
);
