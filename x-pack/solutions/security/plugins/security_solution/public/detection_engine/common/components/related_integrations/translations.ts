...
export const INTEGRATIONS_INSTALLED_TOOLTIP = i18n.translate(
  ...
  {
    defaultMessage:
      'Integration is installed. Configure an integration policy and ensure Cyberstanc Agents are assigned this policy to ingest compatible events.',
  }
);
...
export const INTEGRATIONS_ENABLED_TOOLTIP = i18n.translate(
  ...
  {
    defaultMessage:
      'Integration is installed and an integration policy with the required configuration exists. Ensure Cyberstanc Agents are assigned this policy to ingest compatible events.',
  }
);
