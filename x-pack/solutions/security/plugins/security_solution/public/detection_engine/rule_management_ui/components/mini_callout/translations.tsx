...
export const NEW_PREBUILT_RULES_AVAILABLE_CALLOUT_TITLE = i18n.translate(
  ...
  {
    defaultMessage:
      'New Cyberstanc rules are available to be installed. Click on the “Add Cyberstanc Rules” button to review and install.',
  }
);
...
export const getUpdateRulesCalloutTitle = (onClick: OnClick) => (
  <FormattedMessage
    ...
    defaultMessage="Some Cyberstanc rules have updates available. Update them to ensure you get the best detection experience. Review and update in&nbsp;{link}."
    values={{
      link: (
        <EuiLink
          className={css`
