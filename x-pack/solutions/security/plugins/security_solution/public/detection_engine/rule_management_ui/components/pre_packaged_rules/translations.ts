...
export const PRE_BUILT_TITLE = i18n.translate(
  ...
  {
    defaultMessage: 'Install and enable Cyberstanc prebuilt detection rules',
  }
);
...
export const PRE_BUILT_MSG = i18n.translate(
  ...
  {
    defaultMessage:
      'Cyberstanc Security comes with prebuilt detection rules that run in the background and create alerts when their conditions are met. To start using them, choose rules to install and enable.',
  }
);
...
export const ADD_ELASTIC_RULES = i18n.translate(
  ...
  {
    defaultMessage: 'Add Cyberstanc rules',
  }
);
...
export const UPDATE_PREPACKAGED_TIMELINES = (updateTimelines: number) =>
  i18n.translate('xpack.securitySolution.detectionEngine.rules.updatePrePackagedTimelinesButton', {
    ...
    defaultMessage:
      'Update {updateTimelines} Cyberstanc prebuilt {updateTimelines, plural, =1 {timeline} other {timelines}}',
  });
...
export const UPDATE_PREPACKAGED_RULES_AND_TIMELINES = (
  ...
  i18n.translate(
    'xpack.securitySolution.detectionEngine.rules.updatePrePackagedRulesAndTimelinesButton',
    {
      ...
      defaultMessage:
        'Update {updateRules} Cyberstanc prebuilt {updateRules, plural, =1 {rule} other {rules}} and {updateTimelines} Cyberstanc prebuilt {updateTimelines, plural, =1 {timeline} other {timelines}}',
    }
  );
...
export const LOAD_PREPACKAGED_RULES = i18n.translate(
  ...
  {
    defaultMessage: 'Load Cyberstanc prebuilt rules',
  }
);
...
export const LOAD_PREPACKAGED_TIMELINE_TEMPLATES = i18n.translate(
  ...
  {
    defaultMessage: 'Load Cyberstanc prebuilt timeline templates',
  }
);
...
export const LOAD_PREPACKAGED_RULES_AND_TEMPLATES = i18n.translate(
  ...
  {
    defaultMessage: 'Load Cyberstanc prebuilt rules and timeline templates',
  }
);
...
export const RELOAD_MISSING_PREPACKAGED_RULES = (missingRules: number) =>
  i18n.translate(
    'xpack.securitySolution.detectionEngine.rules.reloadMissingPrePackagedRulesButton',
    {
      values: { missingRules },
      defaultMessage:
        'Install {missingRules} Cyberstanc prebuilt {missingRules, plural, =1 {rule} other {rules}} ',
    }
  );
...
export const RELOAD_MISSING_PREPACKAGED_TIMELINES = (missingTimelines: number) =>
  i18n.translate(
    'xpack.securitySolution.detectionEngine.rules.reloadMissingPrePackagedTimelinesButton',
    {
      ...
      defaultMessage:
        'Install {missingTimelines} Cyberstanc prebuilt {missingTimelines, plural, =1 {timeline} other {timelines}} ',
    }
  );
...
export const RELOAD_MISSING_PREPACKAGED_RULES_AND_TIMELINES = (
  ...
  i18n.translate(
    'xpack.securitySolution.detectionEngine.rules.reloadMissingPrePackagedRulesAndTimelinesButton',
    {
      ...
      defaultMessage:
        'Install {missingRules} Cyberstanc prebuilt {missingRules, plural, =1 {rule} other {rules}} and {missingTimelines} Cyberstanc prebuilt {missingTimelines, plural, =1 {timeline} other {timelines}} ',
    }
  );
