      ...
      return (
        <li key={message}>
          <FormattedMessage
            ...
            defaultMessage="{rulesCount, plural, =1 {# prebuilt Cyberstanc rule} other {# prebuilt Cyberstanc rules}} (editing prebuilt rules is not supported)"
            values={{ rulesCount }}
          />
        </li>
      );
      ...
      return (
        <li key={message}>
          <FormattedMessage
            ...
            defaultMessage="{rulesCount, plural, =1 {# prebuilt Cyberstanc rule} other {# prebuilt Cyberstanc rules}} (exporting prebuilt rules is not supported)"
            values={{ rulesCount }}
          />
        </li>
      );
