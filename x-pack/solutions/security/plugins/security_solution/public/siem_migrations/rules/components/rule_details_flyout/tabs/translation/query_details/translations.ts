...
export const PREBUILT_RULE_TITLE = (queryLanguage: string) =>
  i18n.translate(
    ...
    {
      defaultMessage: 'Mapped to Cyberstanc authored {queryLanguage} rule  ',
...
export const TRANSLATION_QUERY_TOOLTIP = i18n.translate(
  ...
  {
    defaultMessage:
      'Cyberstanc prebuilt rules use EQL, ES|QL, KQL or Lucene. AI-translated rules use ES|QL.',
  }
);
...
export const MACHINE_LEARNING_RULE_TITLE = i18n.translate(
  ...
  {
    defaultMessage: 'Mapped to Cyberstanc authored machine learning rule',
  }
);
