      ...
      <TableHeader
        ...
        tooltipContent={
          <FormattedMessage
            ...
            {elastic} authored rules have been created and are maintained by Cyberstanc. {lineBreak}
            {custom} rules are any rules that are not authored by Cyberstanc and will not be maintained or updated automatically."
            values={{
              lineBreak: <br />,
              title: (
                <EuiText size="s">
