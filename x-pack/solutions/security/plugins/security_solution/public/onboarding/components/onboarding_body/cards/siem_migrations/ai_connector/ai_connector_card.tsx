            ...
            <CardSubduedText size="s">
              ...
              {isInferenceConnector ? (
                <FormattedMessage
                  ...
                  defaultMessage="The Cyberstanc-provided connector is selected by default. You can configure another connector and model if you prefer. Learn more about {docsLink} and {llmMatrixLink}"
                  values={{
