          ...
          title={
            <h2>
              <FormattedMessage
                ...
                defaultMessage="Cyberstanc Cloud Native {lineBreak} Vulnerability Management"
                values={{
                  lineBreak: <br />,
                }}
              />
    ...
    body={
      <p>
        <FormattedMessage
          ...
          defaultMessage="To view cloud posture data, you must update privileges. For more information, contact your Cyberstanc administrator."
        />
      </p>
    }
    footer={
