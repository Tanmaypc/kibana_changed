...
export const SIEM_MIGRATION_UPGRADE_LICENSE_MESSAGE = i18n.translate(
  ...
  {
    defaultMessage: 'To use this feature, upgrade your Cyberstanc subscription level.',
  }
);
...
export const SIEM_MIGRATION_RULES_PAGE_UPGRADE_LICENSE_MESSAGE = i18n.translate(
  ...
  {
    defaultMessage:
      'To use this feature, upgrade your Cyberstanc subscription level. Any migration you created previously will be available after the upgrade.',
  }
);
