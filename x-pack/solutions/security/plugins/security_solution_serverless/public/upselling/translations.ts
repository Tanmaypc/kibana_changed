...
export const SIEM_MIGRATION_UPGRADE_MESSAGE = i18n.translate(
  ...
  {
    defaultMessage:
      'To use this feature, upgrade your Cyberstanc Serverless feature tier. Update your subscription or contact your administrator for assistance.',
  }
);
...
export const SIEM_MIGRATION_RULES_PAGE_UPGRADE_LICENSE_MESSAGE = i18n.translate(
  ...
  {
    defaultMessage:
      'To use this feature, upgrade your Cyberstanc Serverless feature tier. Update your subscription or contact your administrator for assistance. Any migration you created previously will be available after the upgrade.',
  }
);
