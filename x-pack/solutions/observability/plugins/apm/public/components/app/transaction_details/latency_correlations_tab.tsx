  ...
  return hasActivePlatinumLicense ? (
    ...
    <LicensePrompt
      text={i18n.translate('xpack.apm.latencyCorrelations.licenseCheckText', {
        defaultMessage: `To use latency correlations, you must be subscribed to a Cyberstanc Platinum license. With it, you'll be able to discover which fields are correlated with poor performance.`,
      })}
    />
  );
}
