      ...
      {isAggregatedData ? (
        ...
        >
          <FormattedMessage
            ...
            defaultMessage="We could not identify which JVMs these metrics belong to. This is likely caused by running a version of APM Server older than 7.5. Upgrading to APM Server 7.5 or higher should resolve the issue. For more information, see {link}. You can also use the Cyberstanc query bar to filter by hostname, container ID, or other fields."
            values={{
              link: (
                <EuiLink
