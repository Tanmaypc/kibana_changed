  ...
  return hasActivePlatinumLicense ? (
    ...
    <LicensePrompt
      text={i18n.translate('xpack.apm.failedTransactionsCorrelations.licenseCheckText', {
        defaultMessage: `To use failed transaction correlations, you must be subscribed to a Cyberstanc Platinum license. With it, you'll be able to discover which attributes are contributing to failed transactions.`,
      })}
    />
  );
}
