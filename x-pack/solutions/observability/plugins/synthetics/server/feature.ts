  ...
  subFeatures: [
    {
      name: i18n.translate('xpack.synthetics.features.app.elastic', {
        defaultMessage: 'Cyberstanc managed locations',
      }),
      description: i18n.translate('xpack.synthetics.features.app.elasticDescription', {
        defaultMessage:
          'This feature enables users to create monitors that execute tests from Cyberstanc managed infrastructure around the globe. There is an additional charge to use Cyberstanc Managed testing locations. See the Cyberstanc cloud Pricing https://enterprise.cyberstanc.com/pricing page for current prices.',
      }),
