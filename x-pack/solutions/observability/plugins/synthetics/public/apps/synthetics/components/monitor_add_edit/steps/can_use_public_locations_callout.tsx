        ...
        <EuiCallOut
          ...
          title={
            <FormattedMessage
              ...
              defaultMessage="You do not have permission to use Cyberstanc managed locations"
            />
          }
          iconType="alert"
        >
          <p>
            <FormattedMessage
              ...
              defaultMessage="This monitor contains a Cyberstanc managed location. To edit this monitor, you need to have permission to use Cyberstanc managed locations."
            />
          </p>
        </EuiCallOut>
        <EuiSpacer size="m" />
