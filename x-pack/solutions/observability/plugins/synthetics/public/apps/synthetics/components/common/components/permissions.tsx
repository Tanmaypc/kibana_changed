...
export const NEED_PERMISSIONS_PRIVATE_LOCATIONS = i18n.translate(
  ...
  {
    defaultMessage: "You're missing some Cyberstanc privileges to manage private locations",
  }
);
...
export const CANNOT_PERFORM_ACTION_PUBLIC_LOCATIONS = i18n.translate(
  ...
  {
    defaultMessage: 'You do not have sufficient permissions to use Cyberstanc managed locations.',
  }
);
