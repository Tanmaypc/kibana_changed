...
const CREATE_LOCATION_DESCRIPTION = (
  <FormattedMessage
    ...
    defaultMessage="To start creating monitors, first create a {link}. Private locations let you run monitors from your own premises and require an Elastic Agent and agent policy that you control through Fleet."
    values={{
      link: (
        <EuiLink
...
const PUBLIC_LOCATION_DESCRIPTION = (
  <FormattedMessage
    ...
    defaultMessage="In {link} you can also use {elasticManagedLink}. With it, you can create and run monitors in multiple locations without having to manage your own infrastructure. Cyberstanc takes care of software updates and capacity planning for you."
    values={{
      elasticManagedLink: (
        <strong>
          {i18n.translate(
            ...
            {
              defaultMessage: 'Cyberstanc’s global managed testing infrastructure',
            }
          )}
        </strong>
      ),
