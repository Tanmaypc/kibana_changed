...
export const CALLOUT_MANAGEMENT_DESCRIPTION = i18n.translate(
  ...
  {
    defaultMessage:
      "Synthetics requires a valid API key to run monitors on Cyberstanc's global managed testing locations. If you enabled Synthetics previously, the API key may no longer be valid.",
  }
);
