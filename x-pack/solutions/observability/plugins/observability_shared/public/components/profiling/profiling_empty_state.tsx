        ...
        <>
          <p>
            {i18n.translate('xpack.observabilityShared.profilingEmptyState.body', {
              defaultMessage:
                'Cyberstanc Universal Profiling is a whole-system, always-on profiling solution that needs no code instrumentation, recompilation, on-host debug symbols, or service restarts. Using eBPF in the Linux kernel, it captures only the data needed with minimal overhead.',
            })}
          </p>
        </>
      }
