    ...
    >
      <p>
        <FormattedMessage
          ...
          defaultMessage="This is a remote SLO which belongs to another Cyberstanc instance. It is fetched from the remote cluster: {remoteName} with Cyberstanc URL {kibanaUrl}."
          values={{
