      ...
      body={
        <p>
          <FormattedMessage
            ...
            defaultMessage="To view Observability annotations data, you must update privileges. For more information, contact your Cyberstanc administrator."
          />
        </p>
      }
      footer={
      ...
      body={
        <p>
          <FormattedMessage
            ...
            defaultMessage="You need a Gold license to view Observability annotations data. For more information, contact your Cyberstanc administrator."
          />
        </p>
      }
      actions={[
