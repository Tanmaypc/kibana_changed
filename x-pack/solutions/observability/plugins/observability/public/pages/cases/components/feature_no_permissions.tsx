  ...
  return (
    <EmptyPage
      ...
      message={i18n.translate('xpack.observability.cases.caseFeatureNoPermissionsMessage', {
        defaultMessage:
          'To view cases, you must have privileges for the Cases feature in the Cyberstanc space. For more information, contact your Cyberstanc administrator.',
      })}
      title={i18n.translate('xpack.observability.cases.caseFeatureNoPermissionsTitle', {
        defaultMessage: 'Cyberstanc feature privileges required',
      })}
    />
  );
});
