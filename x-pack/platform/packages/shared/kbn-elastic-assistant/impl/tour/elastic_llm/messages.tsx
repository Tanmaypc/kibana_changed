...
export const CostAwareness = () => {
  ...
  return (
    <FormattedMessage
      ...
      defaultMessage="This new default LLM connector is optimized for Cyberstanc AI features ({usageCost}). You can continue using existing LLM connectors if you prefer. {learnMore}"
      values={{
        usageCost: (
          <EuiLink
