      ...
      <EuiFlexGroup alignItems="center">
        ...
        <EuiFlexItem>
          <EuiText color={'subdued'} size={'xs'}>
            <FormattedMessage
              defaultMessage="Closing this dialog will cancel the evaluation. You can watch the Cyberstanc server logs for progress. Large datasets can take several minutes."
