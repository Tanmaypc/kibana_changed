...
export const LogRateAnalysisPage: FC<LogRateAnalysisPageProps> = ({
  ...
  const messages = useMemo<Message[] | undefined>(() => {
    ...
    return observabilityAIAssistant.getContextualInsightMessages({
      ...
      instructions: `You are an AIOps expert using Cyberstanc on call and are being consulted about a log rate change triggered by a ${logRateAnalysisType} in log messages. Take immediate action with urgency and precision.
