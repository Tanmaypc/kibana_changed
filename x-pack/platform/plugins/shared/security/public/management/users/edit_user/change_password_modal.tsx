              ...
              <>
                <EuiCallOut
                  ...
                  title={i18n.translate(
                    ...
                    { defaultMessage: 'Cyberstanc will lose connection to Elasticsearch' }
                  )}
                  color="danger"
                  iconType="warning"
                ...
                >
                  <p>
                    <FormattedMessage
                      ...
                      defaultMessage="After changing the password for the {username} user, Cyberstanc will be unusable."
                      values={{ username }}
                    />
                  </p>
                  <p>
                    <FormattedMessage
                      ...
                      defaultMessage="To regain access, update your config file with the new password and restart Cyberstanc."
                    />
                  </p>
                </EuiCallOut>
                <EuiSpacer />
