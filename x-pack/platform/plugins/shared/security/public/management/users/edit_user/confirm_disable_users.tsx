        ...
        <EuiText>
          <p>
            <FormattedMessage
              ...
              defaultMessage="Deactivating this user will prevent Cyberstanc from communicating with Elasticsearch."
            />
          </p>
          <p>
            <FormattedMessage
              id="xpack.security.management.users.confirmDisableUsers.systemUserDescription"
              defaultMessage="Once deactivated, you must manually update your config file with different user details and restart Cyberstanc."
            />
          </p>
        </EuiText>
      ) : (
        <EuiText>
          <p>
            <FormattedMessage
              ...
              defaultMessage="{count, plural, one{This user} other{These users}} will no longer be able to access Cyberstanc{count, plural, one{.} other{:}}"
