          ...
          <>
            <EuiCallOut
              ...
              title={i18n.translate(
                ...
                {
                  defaultMessage:
                    '{count, plural, one {API key managed by Cyberstanc} other {API keys managed by Cyberstanc}}',
                  values: {
            ...
            >
              <p>
                {i18n.translate(
                  ...
                  {
                    defaultMessage:
                      '{count, plural, one {Deleting this API key may disrupt some Cyberstanc features or functionality.} other {Deleting these API keys may disrupt some Cyberstanc features or functionality.}}',
