  ...
  private getMessage = () => {
    return (
      <FormattedMessage
        ...
        defaultMessage="This role contains privilege definitions for spaces, but spaces are not enabled in Cyberstanc. Saving this role will remove these privileges."
      />
    );
  };
}
