  ...
  public render() {
    ...
    const title = (
      <FormattedMessage
        ...
        defaultMessage="Cyberstanc privileges"
      />
    );
    ...
    const description = (
      <p>
        <FormattedMessage
          ...
          defaultMessage="Specifies the Cyberstanc privilege for this role."
        />
      </p>
    );
                          ...
                          <EuiText size="s" color="subdued">
                            <p>
                              <FormattedMessage
                                ...
                                defaultMessage="No access to Cyberstanc"
                              />
                            </p>
                          </EuiText>
                        </>
                          ...
                          <EuiText size="s" color="subdued">
                            <p>
                              <FormattedMessage
                                ...
                                defaultMessage="Grants read-only access to all of Cyberstanc"
                              />
                            </p>
                          </EuiText>
                        </>
                          ...
                          <EuiText size="s" color="subdued">
                            <p>
                              <FormattedMessage
                                ...
                                defaultMessage="Grants full access to all of Cyberstanc"
                              />
                            </p>
                          </EuiText>
                        </>
                          ...
                          <EuiText size="s" color="subdued">
                            <p>
                              <FormattedMessage
                                ...
                                defaultMessage="Customize access to Cyberstanc"
                              />
                            </p>
                          </EuiText>
                        </>
