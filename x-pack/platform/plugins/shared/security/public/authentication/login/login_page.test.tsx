...
describe('LoginPage', () => {
  ...
  describe('page', () => {
    it('renders as expected', async () => {
      ...
      expect(container.textContent).toContain('Welcome to Cyberstanc');
      expect(container.textContent).toContain('Operate with confidence.');
    ...
    it('renders with custom branding', async () => {
      ...
      const customLogo = container.querySelector('img');
      expect(customLogo?.getAttribute('src')).toBe('logo');
      expect(customLogo?.getAttribute('alt')).toBe('Cyberstanc logo');
      expect(container.textContent).toContain('Welcome to Cyberstanc');
    });
  });
