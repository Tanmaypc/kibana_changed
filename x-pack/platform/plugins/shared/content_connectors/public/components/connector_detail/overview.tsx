        ...
        <>
          ...
          <EuiCallOut
            ...
            title={i18n.translate(
              ...
              {
                defaultMessage:
                  'Cyberstanc-managed connectors (formerly native connectors) are no longer supported outside Elastic Cloud',
              }
            )}
          >
            <EuiSpacer size="s" />
            <EuiText size="s">
              <p>
                <FormattedMessage
                  ...
                  defaultMessage="Convert it to a {link} to self-host it on your own infrastructure. Cyberstanc-managed connectors are available only in your Elastic Cloud deployment."
                  values={{
                    link: (
                      <EuiLink
