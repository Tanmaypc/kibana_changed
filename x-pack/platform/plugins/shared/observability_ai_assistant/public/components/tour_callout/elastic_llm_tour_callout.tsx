    ...
    <TourCallout
      ...
      content={
        <FormattedMessage
          ...
          defaultMessage="This new default LLM connector is optimized for Cyberstanc AI features (<costLink>additional costs incur</costLink>). You can continue using existing LLM connectors if you prefer. <learnMoreLink>Learn more</learnMoreLink>"
          values={{
