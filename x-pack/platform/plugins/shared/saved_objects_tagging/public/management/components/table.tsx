              ...
              <div css={{ marginLeft: euiTheme.size.s }}>
                <EuiIconTip
                  ...
                  content={i18n.translate(
                    ...
                    {
                      defaultMessage:
                        'This {tagName} is managed by Cyberstanc and cannot be deleted, edited, or assigned to objects.',
              ...
              selectableMessage: (selectable) =>
                selectable
                  ...
                  : i18n.translate('xpack.savedObjectsTagging.management.table.managedMessage', {
                      defaultMessage:
                        'This tag is managed by Cyberstanc and cannot be deleted or assigned to objects.',
                    }),
            }
          : undefined
      }
