      ...
      <EuiFlexItem grow={7}>
        <EuiText>
          <FormattedMessage
            ...
            defaultMessage="This documents all the inputs, streams, and variables available to use this integration programmatically via the Cyberstanc Fleet API. {learnMore}"
            values={{
              learnMore: (
