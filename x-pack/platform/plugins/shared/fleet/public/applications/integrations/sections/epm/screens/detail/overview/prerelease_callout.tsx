      ...
      >
        <p>
          <FormattedMessage
            ...
            defaultMessage="The {packageTitle} integration collects {OTelExternalLink} data adhering to {semanticConventionsLink}, and is available in technical preview. To collect OTel data, Cyberstanc Agents must be on version {minVersion} or later. For more information, refer to the {fleetUserGuide}."
            values={{
              packageTitle,
              OTelExternalLink: (
