    ...
    <>
      <EuiCallOut
        ...
        title={i18n.translate('xpack.fleet.epm.wizIntegration.newFeaturesCallout', {
          defaultMessage:
            'New! Starting with version 2.0, ingest vulnerability and misconfiguration findings from Wiz into Cyberstanc and use built-in contextual investigation and threat-hunting workflows.',
        })}
      />
      <EuiSpacer size="s" />
    </>
