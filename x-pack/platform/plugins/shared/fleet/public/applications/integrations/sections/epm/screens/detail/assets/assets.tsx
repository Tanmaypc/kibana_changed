    ...
    content = (
      ...
      >
        <FormattedMessage
          ...
          defaultMessage="You do not have permission to retrieve the Cyberstanc saved object for that integration. Contact your administrator."
        />
      </EuiCallOut>
    );
          ...
          <EuiCallOut
            ...
            title={
              <FormattedMessage
                ...
                defaultMessage="Cyberstanc assets not available in this space"
              />
            }
          >
            <p>
              <FormattedMessage
                ...
                defaultMessage="This integration is installed, but Cyberstanc assets are not available in this space. {learnMoreLink}."
                values={{
                  learnMoreLink: (
                    <EuiLink
