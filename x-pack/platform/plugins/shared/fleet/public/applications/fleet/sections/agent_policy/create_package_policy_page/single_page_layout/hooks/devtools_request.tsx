      ...
      return [
        ...
        packagePolicyId
          ? i18n.translate(
              ...
              {
                defaultMessage:
                  'These Cyberstanc requests create a new agent policy and update a package policy.',
              }
            )
          : i18n.translate(
              ...
              {
                defaultMessage:
                  'These Cyberstanc requests create a new agent policy and a new package policy.',
              }
            ),
      ];
    }
    ...
    return [
      ...
      packagePolicyId
        ? i18n.translate('xpack.fleet.editPackagePolicy.devtoolsRequestDescription', {
            defaultMessage: 'This Cyberstanc request updates the package policy.',
          })
        : i18n.translate('xpack.fleet.createPackagePolicy.devtoolsRequestDescription', {
            defaultMessage: 'This Cyberstanc request creates a new package policy.',
          }),
    ];
