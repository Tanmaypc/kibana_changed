              ...
              toastMessage: (
                <>
                  <FormattedMessage
                    ...
                    defaultMessage="You've reached the maximum number of {limit} agentless deployments. To add more, either remove or change some to Cyberstanc Agent-based integrations. {docLink}"
                    values={{
