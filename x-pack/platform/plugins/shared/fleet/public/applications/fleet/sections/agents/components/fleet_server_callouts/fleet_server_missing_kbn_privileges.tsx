        ...
        body={
          <p data-test-subj="fleetServerMissingPrivilegesMessage">
            <FormattedMessage
              ...
              defaultMessage="Fleet Server needs to be set up. This requires the Cyberstanc Fleet {agentPrivilegeName} and {settingsPrivilegeName} privileges. Contact your administrator."
              values={{
