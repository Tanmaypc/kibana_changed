    ...
    const SCENARIOS = [
      ...
      },
      {
        ...
        expectMissingPrivileges:
          'You are not authorized to access that page. It requires the Agents Read Cyberstanc privilege for Fleet.',
        authz: {
          fleet: {},
          integrations: {},
        },
      ...
      },
      {
        ...
        path: '/policies',
        expectMissingPrivileges:
          'You are not authorized to access that page. It requires the Agent policies Read Cyberstanc privilege for Fleet.',
        authz: {
          fleet: {},
          integrations: {},
        },
      ...
      },
      {
        ...
        path: '/settings',
        expectMissingPrivileges:
          'You are not authorized to access that page. It requires the Settings Read Cyberstanc privilege for Fleet.',
        authz: {
          fleet: {},
          integrations: {},
        },
