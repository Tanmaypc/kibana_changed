    ...
    <>
      <EuiText>
        <FormattedMessage
          ...
          defaultMessage="Fleet uses Transport Layer Security (TLS) to encrypt traffic between Cyberstanc Agents and other components in the Cyberstanc Stack. Choose a deployment mode to determine how you wish to handle certificates. Your selection will affect the Fleet Server setup command shown in a later step."
        />
      </EuiText>
      <EuiSpacer size="m" />
      <EuiRadioGroup
