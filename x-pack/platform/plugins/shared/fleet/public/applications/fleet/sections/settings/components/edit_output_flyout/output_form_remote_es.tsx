      ...
      <EuiCallOut
        title={
          <FormattedMessage
            ...
            defaultMessage="Generate a service token by running this API request in the remote Cyberstanc Console, then copy the response value"
          />
        }
                    ...
                    <ol>
                      <li>
                        <FormattedMessage
                          ...
                          defaultMessage="In the remote cluster, open Cyberstanc, go to {appPath}, and follow the steps to add this cluster."
                          values={{
                            appPath: (
                              <strong>
                                <FormattedMessage
                      ...
                      <li>
                        <FormattedMessage
                          ...
                          defaultMessage="Below, provide the access details for the remote cluster's Cyberstanc instance."
                        />
                      </li>
                    </ol>
                    <EuiSpacer size="s" />
              ...
              <EuiFormRow
                ...
                label={
                  <FormattedMessage
                    ...
                    defaultMessage="Remote Cyberstanc URL"
                  />
                }
              ...
              >
                <EuiFieldText
                  ...
                  placeholder={i18n.translate(
                    ...
                    {
                      defaultMessage: 'Specify Cyberstanc URL',
                    }
                  )}
                />
              </EuiFormRow>
              ...
              <EuiFormRow
                ...
                label={
                  <FormattedMessage
                    ...
                    defaultMessage="Remote Cyberstanc API key"
                  />
                }
              ...
              >
                <EuiFieldPassword
                  ...
                  placeholder={i18n.translate(
                    ...
                    {
                      defaultMessage: 'Specify encoded Cyberstanc API key',
                    }
                  )}
                />
              </EuiFormRow>
              ...
              <EuiCallOut
                title={
                  <FormattedMessage
                    ...
                    defaultMessage="Create an API key by running this API request in the remote Cyberstanc Console, then copy the encoded value"
                  />
                }
