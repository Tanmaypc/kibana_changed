            ...
            <p data-test-subj="missingPrivilegesPromptMessage">
              {requiredFleetRole ? (
                <FormattedMessage
                  ...
                  defaultMessage="You are not authorized to access that page. It requires the {roleName} Cyberstanc privilege for Fleet."
                  values={{
                ...
                <FormattedMessage
                  ...
                  defaultMessage="You are not currently authorized to access {callingApplication}. For access, your Cyberstanc role must include the {roleName2} or {roleName1} privilege for {callingApplication}. {guideLink}"
                  values={{
                    callingApplication,
