      ...
      <EuiText>
        {isFleetServerPolicy ? (
          <FormattedMessage
            ...
            defaultMessage="Fleet Server runs on Cyberstanc Agent, and agents are enrolled in agent policies which represent hosts. You can select an existing agent policy configured for Fleet Server, or you may choose to create a new one."
          />
        ) : (
          <FormattedMessage
