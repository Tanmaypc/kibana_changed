  ...
  const k8sCSPMCallout = (
    <EuiCallOut
      title={i18n.translate('xpack.fleet.enrollmentInstructions.placeHolderCallout', {
        defaultMessage:
          'We strongly advise against deploying CSPM within a Kubernetes cluster. Doing so may cause redundant data fetching, increase consumption costs in your Cyberstanc account, and trigger API rate limits in your cloud accounts.',
      })}
      color="warning"
      iconType="warning"
    />
