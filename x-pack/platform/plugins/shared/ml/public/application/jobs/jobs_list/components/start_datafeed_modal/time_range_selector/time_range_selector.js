          ...
          <>
            <ManagedJobsWarningCallout
              ...
              message={i18n.translate(
                ...
                {
                  defaultMessage:
                    '{jobsCount, plural, one {This job} other {At least one of these jobs}} is preconfigured by Cyberstanc; starting {jobsCount, plural, one {it} other {them}} with a specific end time might impact other parts of the product.',
                  values: {
                    jobsCount: this.props.jobsCount,
                  },
                }
