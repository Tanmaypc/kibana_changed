      ...
      return (
        <p>
          <FormattedMessage
            ...
            defaultMessage={`A large language model (LLM) is required to power the AI Assistant and AI-driven features in Cyberstanc. In order to use the AI Assistant you must ${
    ...
    return (
      <p>
        <FormattedMessage
          ...
          defaultMessage={`A large language model (LLM) is required to power the AI Assistant and AI-powered features. By default, Cyberstanc uses the {elasticManagedLlm} connector ({link}) when no custom connectors are available. When available, Cyberstanc uses the last used custom connector.${
            showSpacesNote
