        ...
        <EuiText>
          ...
          <div>
            <FormattedMessage
              ...
              defaultMessage="Create these out-of-the box rules in this Cyberstanc space?"
            />
        ...
        <EuiText>
          ...
          <p>
            <FormattedMessage
              ...
              defaultMessage="To avoid duplication of work, it will be best to disable those before you create the Cyberstanc rules."
            />
          </p>
          ...
          <p>
            <FormattedMessage
              ...
              defaultMessage="Once all monitoring Watches have been disabled, click Create to create the Cyberstanc rules."
            />
          </p>
        </EuiText>
      </EuiModalBody>
