              ...
              <h3>
                <DisabledIfNoDataAndInSetupModeLink
                  ...
                  aria-label={i18n.translate(
                    ...
                    {
                      defaultMessage: 'Cyberstanc Overview',
                    }
                  )}
                  ...
                  <h3>
                    <EuiLink
                      ...
                      aria-label={i18n.translate(
                        ...
                        {
                          defaultMessage: 'Cyberstanc Instances: {instancesCount}',
    ...
    <>
      <div style={{ marginBottom: '8px' }}>
        <EuiToolTip position="top" content={staleMessage}>
          <EuiBadge iconType="warning" color="warning" tabIndex={0} data-test-subj="status">
