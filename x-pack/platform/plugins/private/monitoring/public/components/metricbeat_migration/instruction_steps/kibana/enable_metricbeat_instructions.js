...
export function getKibanaInstructionsForEnablingMetricbeat(product, _meta, { esMonitoringUrl }) {
  ...
  const installMetricbeatStep = {
    title: i18n.translate(
      ...
      {
        defaultMessage: 'Install Metricbeat on the same server as Cyberstanc',
      }
    ),
    children: (
      <EuiText>
        ...
        <EuiText>
          <p>
            <FormattedMessage
              ...
              defaultMessage="By default the module will collect Cyberstanc monitoring metrics from http://localhost:5601. If the local Cyberstanc instance has a different address, you must specify it via the {hosts} setting in the {file} file."
              values={{
