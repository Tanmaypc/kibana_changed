    ...
    try {
      ...
      setActionError(
        i18n.translate(
          ...
          { defaultMessage: 'Cyberstanc documentation failed to install' }
        ) + `: ${msg}`
      );
    }
    ...
    overlays
      .openConfirm(
        i18n.translate(
          ...
          { defaultMessage: `Are you sure you want to uninstall the Cyberstanc documentation?` }
        ),
        {
          title: i18n.translate(
            'xpack.observabilityAiAssistantManagement.settingsPage.productDocUninstallConfirmTitle',
            { defaultMessage: `Uninstalling Cyberstanc documentation` }
          ),
        }
      )
      .then((confirmed) => {
            ...
            <EuiText size="s">
              <p>
                {i18n.translate(
                  ...
                  {
                    defaultMessage:
                      'Cyberstanc documentation is not available. In an air-gapped environment, use a local artifact to make the product documentation available to Cyberstanc.',
                  }
                )}
              </p>
              <p>
