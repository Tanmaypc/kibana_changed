...
export const outlinkEncoders: OutlinkEncoder[] = [
  ...
  },
  {
    ...
    description: i18n.translate('xpack.graph.outlinkEncoders.esqRisonLooseDescription', {
      defaultMessage:
        'Rison-encoded JSON, minimum_should_match=1, compatible with most Cyberstanc URLs',
    }),
    encode(workspace) {
  ...
  },
  {
    ...
    description: i18n.translate('xpack.graph.outlinkEncoders.esqRisonDescription', {
      defaultMessage:
        'Rison-encoded JSON, minimum_should_match=2, compatible with most Cyberstanc URLs',
    }),
    encode(workspace) {
      return encodeURIComponent(
