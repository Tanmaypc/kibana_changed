        ...
        <EuiText>
          <p>
            <FormattedMessage
              ...
              defaultMessage="You must resolve any critical Elasticsearch and Cyberstanc configuration issues before upgrading to the next version of the Cyberstanc platform. Ignoring warnings might result in differences in behavior after you upgrade."
            />
          </p>
        </EuiText>
