        ...
        <EuiText>
          ...
          <p>
            <FormattedMessage
              ...
              defaultMessage="Reindexing is performed in the background. You can return to the Upgrade Assistant to view progress or resume reindexing after a Cyberstanc restart."
            />
          </p>
        </EuiText>
        <EuiSpacer />
