...
const i18nTexts = {
  pageTitle: i18n.translate('xpack.upgradeAssistant.kibanaDeprecations.pageTitle', {
    defaultMessage: 'Cyberstanc deprecation issues',
  }),
  ...
  getKibanaDeprecationErrorDescription: (pluginIds: string[]) =>
    i18n.translate('xpack.upgradeAssistant.kibanaDeprecations.kibanaDeprecationErrorDescription', {
      defaultMessage:
        'Failed to get deprecation issues for {pluginCount, plural, one {this plugin} other {these plugins}}: {pluginIds}. Check the Cyberstanc server logs for more information.',
      values: {
...
export const KibanaDeprecationsList = ({
  ...
  if (error) {
    return <DeprecationsPageLoadingError deprecationSource="Cyberstanc" />;
  }
