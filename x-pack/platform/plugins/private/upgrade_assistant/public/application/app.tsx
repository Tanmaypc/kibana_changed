      ...
      <NotAuthorizedSection
        ...
        title={
          <FormattedMessage
            ...
            defaultMessage="Cyberstanc admin role required"
          />
        }
        message={
          <FormattedMessage
            id="xpack.upgradeAssistant.app.deniedPrivilegeDescription"
            defaultMessage="To use Upgrade Assistant and resolve deprecation issues, you must have access to manage all Cyberstanc spaces."
          />
        }
      />
    );
          ...
          <p>
            <FormattedMessage
              ...
              defaultMessage="One or more Elasticsearch nodes have a newer version of
                Elasticsearch than Cyberstanc. Once all your nodes are upgraded, upgrade Cyberstanc."
            />
          </p>
        }
        ...
        body={
          <p>
            <FormattedMessage
              ...
              defaultMessage="All Elasticsearch nodes have been upgraded. You may now upgrade Cyberstanc."
            />
          </p>
        }
