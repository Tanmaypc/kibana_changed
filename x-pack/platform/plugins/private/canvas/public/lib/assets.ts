...
const strings = {
  ...
  getTooLargeErrorMessage: () =>
    i18n.translate('xpack.canvas.error.esPersist.tooLargeErrorMessage', {
      defaultMessage:
        'The server reported that the workpad data is too large. This usually means uploaded image assets exceed the Cyberstanc or proxy limit. Remove some assets in the asset manager and try again.',
    }),
