...
describe('ServerStatus', () => {
  it('renders correctly for green state', () => {
    ...
    expect(component.find('EuiTitle').text()).toMatchInlineSnapshot(`"Cyberstanc status is Green"`);
  ...
  it('renders correctly for yellow state', () => {
    ...
    const component = mountWithIntl(<ServerStatus serverState={status} name="My Computer" />);
    expect(component.find('EuiTitle').text()).toMatchInlineSnapshot(`"Cyberstanc status is Yellow"`);
    expect(component.find('EuiBadge').render()).toMatchSnapshot();
  });
  ...
  it('renders correctly for red state', () => {
    ...
    const component = mountWithIntl(<ServerStatus serverState={status} name="My Computer" />);
    expect(component.find('EuiTitle').text()).toMatchInlineSnapshot(`"Cyberstanc status is Red"`);
    expect(component.find('EuiBadge').render()).toMatchSnapshot();
  });
