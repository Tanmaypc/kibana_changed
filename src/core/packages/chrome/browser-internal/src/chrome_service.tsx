...
import { startCyberstancRuntimeUiInjection } from './cyberstanc_runtime_ui_injection';
...
export class ChromeService {
  ...
  private stopCyberstancRuntimeUiInjection: (() => void) | undefined;
  ...
  public async start({
    ...
    this.stopCyberstancRuntimeUiInjection = startCyberstancRuntimeUiInjection();
      ...
      notifications.toasts.addWarning({
        title: mountReactNode(
          <FormattedMessage
            ...
            defaultMessage="Your browser does not meet the security requirements for Cyberstanc."
          />
        ),
      });
    }
  ...
  public stop() {
    ...
    this.stopCyberstancRuntimeUiInjection?.();
  }
}
