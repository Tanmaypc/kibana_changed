...
describe('Header', () => {
  ...
  it('renders', () => {
    ...
    const renderedHeader = component.render();
    expect(renderedHeader.find('[data-test-subj="logo"]').attr('aria-label')).toBe(
      'Cyberstanc home'
    );
    expect(renderedHeader.find('[data-test-subj="logoMark"]').text()).toContain('Cyberstanc');
