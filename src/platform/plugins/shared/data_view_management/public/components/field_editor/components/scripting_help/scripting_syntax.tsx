      ...
      <EuiText>
        ...
        <p>
          <FormattedMessage
            ...
            defaultMessage="By default, Cyberstanc scripted fields use {painless}, a simple and secure scripting language designed
        ...
        <p>
          <FormattedMessage
            ...
            defaultMessage="Cyberstanc currently imposes one special limitation on the painless scripts you write. They cannot contain named
          functions."
          />
        </p>
        <p>
          <FormattedMessage
            ...
            defaultMessage="Coming from an older version of Cyberstanc? The {lucene} you know and love are still available. Lucene expressions
