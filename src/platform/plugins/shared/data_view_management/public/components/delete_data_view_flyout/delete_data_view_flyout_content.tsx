...
export const spacesWarningText = i18n.translate(
  ...
  {
    defaultMessage:
      'Deleting a data view permanently removes it from all spaces and prevents all users from using it in Cyberstanc apps such as Discover, Dashboards, or Lens. This action cannot be undone.',
  }
);
...
export const relationshipCalloutText = i18n.translate(
  ...
  {
    defaultMessage:
      'At least one data view you want to delete is used by another Cyberstanc object. Review the affected objects to avoid disrupting other Cyberstanc users. Deleting data views permanently removes them from all spaces and cannot be undone.',
  }
);
