...
export const EditIndexPattern = withRouter(
  ({ indexPattern, history, location }: EditIndexPatternProps) => {
    ...
    const mappingConflictLabel = i18n.translate(
      ...
      {
        defaultMessage:
          '{conflictFieldsLength, plural, one {A field is} other {# fields are}} defined as several types (string, integer, etc.) across the indices that match this pattern. You may still be able to use these conflict fields in parts of Cyberstanc, but they will be unavailable for functions that require Cyberstanc to know their type. Correcting this issue requires reindexing your data.',
