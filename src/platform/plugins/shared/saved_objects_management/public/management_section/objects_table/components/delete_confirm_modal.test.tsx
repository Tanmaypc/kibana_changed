...
describe('DeleteConfirmModal', () => {
  ...
  it('displays a Cyberstanc loading spinner if `isDeleting` is true', () => {
    ...
    expect(wrapper.find('[data-test-subj="cyberstancDeleteSavedObjectsSpinner"]')).toHaveLength(1);
  ...
  it('displays a EuiLoadingSpinner if `isDeleting` is true and `showPlainSpinner` is true', () => {
    ...
    expect(wrapper.find('[data-test-subj="cyberstancDeleteSavedObjectsSpinner"]')).toHaveLength(0);
