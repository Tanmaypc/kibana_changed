      ...
      body={
        <p>
          <FormattedMessage
            ...
            defaultMessage="If your Cyberstanc instance doesn’t have internet access, ask your administrator to disable this feature. Otherwise, we’ll keep trying to fetch the news."
          />
        </p>
      }
    />
