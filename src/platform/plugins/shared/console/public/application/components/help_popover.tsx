        ...
        <EuiTitle size="xs">
          <h4>
            {i18n.translate('console.helpPopover.title', {
              defaultMessage: 'Cyberstanc Console',
            })}
          </h4>
        </EuiTitle>
        ...
        <EuiText css={styles.fixedWidthText} color="subdued" size="s">
          <p>
            {i18n.translate('console.helpPopover.description', {
              defaultMessage:
                'Console is an interactive UI for calling Elasticsearch and Cyberstanc APIs and viewing their responses. Search your data, manage settings, and more, using Query DSL and REST API syntax.',
            })}
          </p>
        </EuiText>
      </EuiPanel>
