      ...
      content: (
        <EuiText>
          {i18n.translate('console.tour.shellStepContent', {
            defaultMessage:
              'Console is an interactive UI for calling Elasticsearch and Cyberstanc APIs and viewing their responses. Use Query DSL syntax to search your data, manage settings, and more.',
          })}
        </EuiText>
      ),
